...
class ResultsTabs(QWidget):
    ...
    def create_tab(self, indice):
        ...
        tab.layout.addWidget(rec.table1, 0, 0)
        ...
        tab.layout.addWidget(rec.table2, 0, 1)
        ...
        tab.layout.addWidget(rec.table3, 1, 0)  # if i add the buttons directly to Results/createQTable, how do i link them?
