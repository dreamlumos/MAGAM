...
class Result(QWidget):
    ...
    def __init__(self, system_state, ind, parent=None):
        ...
        # self.load_acts_btn = QPushButton("Modify Table")
        # self.load_acts_btn.setToolTip("Change the activities table.")
        # self.load_acts_btn.clicked.connect(self.load_acts_file)
        # self.load_acts_btn.clicked.connect(self.modify_acts_table)
        # self.table2.layout.addWidget(self.load_acts_btn)
